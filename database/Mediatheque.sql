...
--
-- Hôte : localhost:8889
-- Généré le : lun. 02 mai 2022 à 10:34
...
(2, 'Intouchable', 107, 'A la suite d\'un accident de parapente, Philippe, riche aristocrate, engage comme aide à domicile Driss, un jeune de banlieue tout juste sorti de prison! ', 'Eric Toledano', 2, 'http://fr.web.img6.acsta.net/r_1280_720/medias/nmedia/18/82/69/17/19806656.jpg'),
(3, 'Gravity', 91, 'En mission à bord de la navette Explorer, l\'astronaute Matt Kowalski et la docteure Ryan Stone, experte en ingénierie médicale, sortent de l\'appareil afin d\'effectuer des réparations sur le télescope Hubble. Bientôt, l\'un et l\'autre sont pris dans une gigantesque tempête de débris provenant de la destruction d\'un satellite. Seuls survivants de leur équipage, les deux astronautes doivent à tout prix rejoindre la station spatiale internationale pour revenir sains et saufs sur Terre.', 'Alfonso Cuaràn', 1, 'http://fr.web.img2.acsta.net/c_215_290/pictures/210/232/21023233_20130729173134181.jpg'),
...
(6, 'Old Boy', 120, 'A la fin des années 80, Oh Dae-Soo, père de famille sans histoire, est enlevé un jour devant chez lui.', 'Park Chan-wook', 5, 'http://fr.web.img6.acsta.net/c_215_290/medias/nmedia/18/35/24/25/18383433.jpg'),
(7, 'Dracula', 155, 'En 1492, le prince Vlad Dracul, revenant de combattre les armées turques, trouve sa fiancée suicidée.', 'Francis Ford Coppola', 5, 'http://fr.web.img6.acsta.net/c_215_290/medias/nmedia/18/64/49/73/18857494.jpg'),
...
(11, '300', 117, 'Adapté du roman graphique de Frank Miller, 300 est un récit épique de la Bataille des Thermopyles, qui opposa en l\'an - 480 le roi Léonidas et 300 soldats spartiates à Xerxes et l\'immense armée perse.', 'Zack Snyder', 7, 'https://aws.vdkimg.com/film/4/1/0/4/4104_poster_scale_188x250.jpg'),
...
(15, 'Les Huit salopards', 187, 'Après la Guerre de Sécession, huit voyageurs se retrouvent coincés dans un refuge au milieu des montagnes. Alors que la tempête s\'abat au-dessus du massif, ils réalisent qu\'ils n\'arriveront peut-être pas à rallier Red Rock comme prévu...', 'Quentin Tarantino', 8, 'https://aws2.vdkimg.com/film/1/1/9/6/1196585_poster_scale_188x250.jpg'),
...
(8, 'admin', 'freddypeltier21@outlook.fr', '$2y$10$5m1djz15o0nNkbqIRNJc2.kS/HX45RX1el14A5eVt9xZnuP2bfgWK', 'Freddy', 'Peltier'),
(11, 'guest', 'freddy@gmail.com', '$2y$10$CNZgo8pw7t7S/oC85UTMQOErX1INehoq28fS6JCQ247iq2V/XjgSi', 'Freddy', 'Peltier'),
(12, 'guest', 'freddy@gmail.com', '$2y$10$2VIJJb7LdW3E0VLzeCUpG.bZCjox4fquSfzMA.4eVMLfSqvgCd0dO', 'Freddy', 'Peltier');
