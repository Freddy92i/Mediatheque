...
// Fetch movies released in the last 12 months
fetch(`https://api.themoviedb.org/3/discover/movie?api_key=${API_KEY}&language=en-US&sort_by=popularity.desc&release_date.gte=${releaseDateString}&page=1`)
